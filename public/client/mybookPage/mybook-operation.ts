document.addEventListener("DOMContentLoaded", ()=>{
    ...
    bookListItems.forEach((bookItem) => {
        const readBtn = bookItem.querySelector('.mybook-read-btn') as HTMLInputElement | null;
        const refundBtn = bookItem.querySelector('.mybook-refund-btn') as HTMLInputElement | null;
        if(readBtn){
