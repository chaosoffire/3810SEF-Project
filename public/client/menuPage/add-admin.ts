import {signUpPayload,signUpError} from "../../frontend/Interface/interface";

const addAdminTagEl = document.querySelector("#add-admin-tag") as HTMLAnchorElement|null;
...
addAdminTagEl?.addEventListener('click',async()=>{
    ...
    while(true){
        ...
        if(username === null || password === null){
            ...
            window.alert("Username must starts with a letter, and contains only number, character and underscore");
            ...
            window.alert("Password must include an uppercase, lowercase, number");
        }else{
            break;
        }
    }
